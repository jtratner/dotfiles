...
# c.IPythonQtConsoleApp.ipython_dir = u'/Users/jtratner/.ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHON_DIR.
# c.IPKernelApp.ipython_dir = u'/Users/jtratner/.ipython'
...
c.ZMQInteractiveShell.logappend = os.path.expanduser('~/ipythonlogs/%s-ipython_log.py' % strftime('%Y-%m-%d'))
